...
public abstract class BaseClass {
    ...
    protected static void extentReportStart(String location) {
        try {
            ...
            Assert.fail("ERROR : DURING EXTENT REPORT START");
        }
    }
    ...
    protected static void extentReportTearDown(String location){
        ...
        {
            Assert.fail("ERROR : DURING EXPORTREPORT TEARDOWN");
        }
    }
    ...
    protected static String takeScreenshot() {
       ...
       try {
            ...
            destfile = new File("Screenshot\\.png" + "=" + timestamp + ".png");
    ...
    protected static void validation(WebElement element, String expected) {
        try {
            ...
            Assert.fail("ERROR:ERROR DURING VALIDATION");
        }
    }
    /// //////////////////////////////////////////////////
